...
export class OrderDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OrderDetailComponent>  ) { this.orderDetail = order['order']; }

  ngOnInit(
  ) { this.calculateCosts(this.orderDetail); console.dir(`Dialog config: ${this.dialogConfig}`); }
